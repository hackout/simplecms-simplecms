        ...
        <main>
            ...
            <section class="section">
                <div class="container items-grid">
                    <article v-for="(item, idx) in items" :key="idx" class="product-card">
...
.product-card { background: #fff; border: 1px solid $line; border-radius: 20px; padding: 28px 22px; box-shadow: 0 12px 30px rgba(15, 23, 42, 0.03); }
...
.product-card p { margin: 0; color: $muted; line-height: 1.9; }
